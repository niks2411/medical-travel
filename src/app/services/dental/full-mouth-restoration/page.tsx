...
export default function FullMouthRestorationPage() {
  ...
  const faqItems = [
    {
      question: "What is Full Mouth Restoration?",
      answer: "A full mouth restoration is a dental treatment that includes multiple treatments like dental implants, root canal treatment, gum treatment, crowns and bridges, bite correction, and many other treatments. In a full mouth restoration, these treatments can be customised based on your needs to provide you with satisfying results."
    },
    {
      question: "Why should I choose the HPT company for full mouth restoration in other countries?",
      answer: "In countries like Thailand, India, Bali, Singapore, and many others, dental treatment can be done at a very low price but with complete world-class facilities, and we will connect you with the best. Our experts are linked with top multinational hospitals and provide full support during and after treatment. Additionally, we also provide ethical recommendations and reduce unnecessary work. This helps you to save both time and money."
    },
    {
      question: "How to book my first treatment?",
      answer: "Booking your first full mouth restoration treatment with us is very simple; just make a phone call on the number given below or send us an email and consult with the experts."
    },
    {
      question: "What is the Role of the HPT company in the treatment process?",
      answer: "From connecting you with the experts to consulting your issues with the experienced professionals in foreign countries, we take care of everything. We also provide you with the proper schedule of flights and appointments after a transparent discussion. Our experts also provide you with complete support, from taking you there and in your treatment to taking you back home and providing care in your country during recovery."
    },
    {
      question: "Is it safe to travel to foreign countries for full mouth restoration?",
      answer: "The team of professionals will always be in touch with you. You don't have to worry about anything because your safety is completely our responsibility. We ensure you a safe and comfortable treatment and good recovery, and focus on customer satisfaction."
    }
  ];
  ...
  const benefitsList = [
    {
      ...
      desc: "Address multiple decayed, weak, or missing teeth together in a planned way instead of fixing one single issue at a time."
    },
    {
    ...
    },
    {
      ...
      desc: "Correct overall bite alignment, teeth structure, and gum health to secure your long-term oral functions."
    }
  ];
  ...
  const journeySteps = [
    {
      ...
      desc: "Your dental reports, scans, and concerns are reviewed by the treating specialists so that advice on a suitable treatment approach can be provided. The expected timeline, along with the possible stages of the treatment, are also discussed before planning any travel."
    },
    {
      num: "02",
      title: "During Your Journey For Treatment",
      desc: "After the finalization of your treatment, we arrange everything for your treatment journey—from scheduling your appointments to accommodation, travel, stay coordination, and follow-ups to keep the process hassle-free."
    },
    {
      num: "03",
  ...
  const testimonials = [
    {
      text: "I lost the hope of getting a proper facial design after my bike accident. With the HPT company I got the chance to meet the global level experts within my budget. Thanks to their full mouth restoration services and end-to-end support, which gave me a new life.",
      author: "Mark A.",
      title: "Full Mouth Restoration Patient",
      avatar: "/mindera_testimonial_1.png"
    },
    {
      text: "Whenever I tried to eat something, my mouth would pain, and it also started while speaking. I had no idea what to do, so then the experts at the HPT team suggested me a full mouth restoration. I was still worried about going to another country, but their complete support helped me feel like I was home. I would definitely recommend the HPT company if you are looking for a top-class mouth restoration.",
      author: "Sandra K.",
      title: "International Restoration Client",
    ...
    <div className="min-h-screen bg-[#fafdfc] text-[#1c2e2c] flex flex-col font-sans">
      ...
      <section className="relative w-full flex flex-col lg:flex-row min-h-[calc(100vh-92px)]">
        ...
        <div className="w-full lg:w-[55%] bg-white flex flex-col justify-center p-6 sm:p-10 lg:p-12 xl:p-16 py-16 lg:py-20 text-left">
          <div className="my-auto py-12 lg:py-0 max-w-2xl">
            ...
            <p className="text-base sm:text-lg text-brand-teal/70 leading-relaxed mb-6 font-light">
              Full mouth restoration refers to a planned approach for treating a wide range of dental concerns across the mouth that may incorporate crowns, implants, bridges, and other restorative procedures.
            </p>
            <p className="text-base sm:text-lg text-[#1c2e2c]/75 leading-relaxed mb-10 font-light">
              When multiple dental concerns affect your daily comfort, speaking, and chewing, a comprehensive restoration approach restores the shape, function, and aesthetics of your teeth. Preserving your natural structure and improving oral health, we coordinate custom options with trusted specialists.
            </p>
        ...
        <div className="w-full lg:w-[45%] relative h-[500px] lg:absolute lg:inset-y-0 lg:right-0 lg:h-full bg-brand-mint-dark overflow-hidden">
          <Image
            src="/restoration_hero.png"
            alt="Beautiful natural full mouth restoration smile"
            fill
            priority
      ...
      {/* 2.5. WHAT IS FULL MOUTH RESTORATION VISUALIZATION SECTION */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-12">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center text-left">
              ...
              <div className="border-t border-brand-teal/10 pt-6 mt-6">
                <h4 className="text-sm font-bold text-[#1c2e2c] uppercase tracking-wider mb-4">Why Patients Consider Treatment Abroad</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center gap-2">
                    <span className="text-brand-teal">✦</span>
                    <span className="text-sm text-[#1c2e2c]/80 font-light">Several Dental Treatments</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-brand-teal">✦</span>
                    <span className="text-sm text-[#1c2e2c]/80 font-light">Experienced Specialists</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-brand-teal">✦</span>
                    <span className="text-sm text-[#1c2e2c]/80 font-light">Shorter Waiting Period</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-brand-teal">✦</span>
                    <span className="text-sm text-[#1c2e2c]/80 font-light">Affordable Combined Costs</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 w-full">
              <div className="w-full relative aspect-square rounded-[2rem] overflow-hidden shadow-lg border border-brand-teal/5 bg-[#f6faf9] flex items-center justify-center">
                <Image
                  ...
                  alt="Full mouth restoration step diagram"
                  fill
          ...
          <div className="w-full">
            <div className="w-full relative aspect-[16/9] sm:aspect-[21/9] md:aspect-[24/9] lg:aspect-[32/11] rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-lg border border-brand-teal/5 bg-[#f6faf9] flex items-center justify-center">
              <Image
                ...
                alt="Full mouth restoration procedure visualization"
                fill
              ...
              <div className="flex flex-col gap-10">
                <div className="text-left w-full">
                  <h3 className="text-2xl sm:text-3xl font-bold text-[#1c2e2c] mb-4">
                    Who May Undergo A Full Mouth Restoration Treatment?
                  </h3>
                  <p className="text-brand-teal/70 text-base font-light leading-relaxed">
                    Your specialist may recommend a full mouth restoration treatment if you suffer from multiple missing, worn, damaged, or weakened teeth across the mouth.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                  ...
                  <div className="bg-[#f4faf9] border border-brand-teal/5 rounded-2xl p-6 sm:p-8 hover:shadow-md transition-shadow duration-300 flex flex-col justify-between">
                    <div>
                      ...
                      <h4 className="text-lg font-bold text-[#1c2e2c] mb-2">Multiple affected, damaged or weak teeth</h4>
                      <p className="text-[#556966] text-sm leading-relaxed font-light mb-4">
                        Patients suffering from multiple missing, worn, damaged, or weakened teeth across the mouth.
                      </p>
                    </div>
                    <div className="flex gap-2 mt-auto">
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Multiple wear</span>
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Weak teeth preservation</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f4faf9] border border-brand-teal/5 rounded-2xl p-6 sm:p-8 hover:shadow-md transition-shadow duration-300 flex flex-col justify-between">
                    <div>
                      ...
                      <h4 className="text-lg font-bold text-[#1c2e2c] mb-2">Discomfort while speaking or chewing</h4>
                      <p className="text-[#556966] text-sm leading-relaxed font-light mb-4">
                        Experiencing discomfort while speaking or chewing because of several affected teeth across different quadrants.
                      </p>
                    </div>
                    <div className="flex gap-2 mt-auto">
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Mouth pain fix</span>
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Function restored</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f4faf9] border border-brand-teal/5 rounded-2xl p-6 sm:p-8 hover:shadow-md transition-shadow duration-300 flex flex-col justify-between">
                    ...
                    <div className="flex gap-2 mt-auto">
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Recurrent issue fix</span>
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Full mouth check</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f4faf9] border border-brand-teal/5 rounded-2xl p-6 sm:p-8 hover:shadow-md transition-shadow duration-300 flex flex-col justify-between">
                    ...
                    <div className="flex gap-2 mt-auto">
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Face shape restoration</span>
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Bite height alignment</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="lg:col-span-5 w-full">
                  <div className="w-full relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-lg border border-white bg-white">
                    <Image
                      ...
                      alt="Full mouth restoration benefits overview"
                      fill
                      className="object-cover"
                      sizes="(max-w-1024px) 100vw, 400px"
                    />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start w-full">
                ...
                <div className="lg:col-span-6 flex flex-col items-start text-left">
                  ...
                  <h3 className="text-3xl sm:text-4xl lg:text-[38px] font-bold tracking-tight text-[#1c2e2c] leading-[1.15] font-sans mb-8">
                    Your Full Mouth Restoration Journey <span className="font-serif italic font-normal text-brand-teal">With HPT</span>
                  </h3>
      ...
      {/* 4. HOW HPT SUPPORTS YOU (Why Choose Us) */}
      ...
      <section className="w-full text-white py-24 sm:py-32 relative overflow-hidden flex items-center justify-center min-h-[500px]">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10 flex flex-col items-center">
          ...
          <p className="text-base sm:text-lg text-white/90 leading-relaxed font-light mb-10 max-w-2xl mx-auto">
            Contact us now to know more about the full mouth restoration service and our assured travel plans. Click on the button below and get a free consultation now.
          </p>
      ...
      {/* 7. CTA-2 (Booking Form - Preselected with Restoration) */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col items-start text-left">
              ...
              <p className="text-base sm:text-lg text-brand-teal/70 leading-relaxed font-light mb-10 max-w-md">
                Sharing all your available reports or dental concerns with our associated specialists can help you have a better understanding of all kinds of possible treatment options.
              </p>
                ...
                <form onSubmit={handleFormSubmit} className="bg-white border border-[#e5ebe9] rounded-[2rem] p-6 sm:p-10 shadow-[0_10px_45px_rgba(0,0,0,0.02)] flex flex-col gap-6 text-left">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <textarea
                      id="message"
                      rows={4}
                      placeholder="Describe your multiple dental issues, accident history, or treatment goals..."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-5 bg-[#e8f1ef] rounded-[2rem] p-6 sm:p-8 flex flex-col gap-6 text-left">
              <div className="relative w-full aspect-[1.2/1] rounded-2xl overflow-hidden shadow-sm">
                <Image src="/mindera_support_group_clean.png" alt="Full mouth restoration support and FAQ information" fill className="object-cover" sizes="(max-w-768px) 100vw, 400px" />
              </div>
              ...
              <div>
                ...
                <p className="text-[13px] text-brand-teal/75 leading-relaxed font-light mt-3">
                  Contact us now to know more about the full mouth restoration service and our assured travel plans.
                </p>
              </div>
            ...
            <div className="lg:col-span-7 flex flex-col text-left">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-[42px] font-bold tracking-tight text-[#1c2e2c] leading-[1.15] font-sans mb-10">
                ...
                About <span className="font-serif italic font-normal text-brand-teal">Full Mouth Restoration</span>
              </h2>

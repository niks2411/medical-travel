...
export default function DentalBridgesPage() {
  ...
  const faqItems = [
    {
      question: "Who needs a dental bridge?",
      answer: "When you have one or more missing teeth in a row, and teeth around the gap are strong enough to support a bridge, then a dental bridge is perfect for you. It can help you to regain your ability to speak comfortably and maintain your facial shape."
    },
    {
      question: "How durable are our dental bridges?",
      answer: "With proper care, you can maintain your dental bridges for up to 10 to 15 years and even more. Your oral hygiene and the quality of material used also impact the durability of the dental bridge."
    },
    {
      question: "Are dental bridges normally visible?",
      answer: "Modern dental bridges are not that visible. Countries like India, Singapore, and Bali use Hi-Tech gadgets to design a perfect bridge that blends with other teeth. The colour, shape, and design are so perfect that they almost look natural."
    },
    {
      question: "What makes a dental bridge different from a dental implant?",
      answer: "A dental bridge uses the teeth beside the gap to get the support, but with implants, the tooth root is separated completely within the artificial tooth. Both are used in different conditions and preferences; you don't have to worry about anything because our expert team will always suggest the perfect option for you."
    },
    {
      question: "Is it safe to get a dental bridge abroad?",
      answer: "Yes, with HPT company, you get a properly planned routine to travel to a different country for advanced dental care. Our experience and proper coordination with a world-class dentist make your experience smooth."
    },
    {
      question: "How many sittings are usually required for a bridge?",
      answer: "In most cases, dental bridges are completed in 2-3 appointments to ensure the proper fit, comfort, and long-term success of patients."
    },
    {
      question: "Can I eat normally with a dental bridge?",
      answer: "Once the dental bridge is fitted properly and you have adjusted to it and become comfortable with it, you can eat normally with it."
    }
  ];

  const benefitsList = [
    {
      title: "Chewing Support",
      desc: "With a dental bridge, you will not face difficulty in chewing or speaking. It's designed to make your daily mouth-related activities more comfortable than before."
    },
    {
      title: "Visible Gap Closure",
      desc: "The gap in your teeth due to one or more missing teeth is now covered properly. This helps to regain your face shape and your confident smile."
    },
    {
      title: "Prevent Nearby Tooth Movement",
      desc: "You will start to notice that your teeth start shifting due to the missing tooth gap. A dental bridge helps to stop this shifting and maintain a proper set of teeth."
    },
    {
      title: "Non-Removable Fixed Option",
      desc: "A dental bridge is a non-removable or fixed option for the replacement of missing teeth in appropriate cases. These are placed permanently in the mouth and can't be removed like dentures, serving patients with a stable and natural feeling solution."
    }
  ];
  ...
  const journeySteps = [
    {
      num: "01",
      title: "Consultation and Tooth Assessment",
      desc: "Firstly, when you contact us, you will get a consultation from a top dental expert who will evaluate your problem and check your suitability for an overseas dental bridge treatment."
    },
    {
      num: "02",
      title: "Bridge Planning and Tooth Preparation",
      desc: "If you are suitable for the foreign treatment, then preparations like your travel pass and other formalities like booking appointments are completed. Then you are comfortably sent to the country you select for dental bridge treatment."
    },
    {
      num: "03",
      title: "Bridge Placement and Adjustment",
      desc: "Specialists take an impression of our missing teeth, and on the basis of that shape, they create a custom design. To serve you with a close to natural look, they perform the final placement and adjustments. After discharge, you will return home and continue your recovery."
    }
  ];

  const testimonials = [
    {
      text: "I lost my teeth, and for a very long time, it didn't grow back. I didn't want a dental implant, but it was creating a problem for me, so experts from HPT recommended me for a dental bridge. Thanks to them, now I can eat comfortably again, and they look natural.",
      author: "Linda M.",
      title: "Dental Bridge Patient",
      avatar: "/mindera_therapist_3.png"
    },
    {
      text: "Whenever I eat something, my teeth get a high sensation. A dentist told me that my teeth are badly damaged. To fix it, I must remove them or get a bridge restoration. The complete process from consultation to dropping me back home was very comfortable. It almost feels like nothing happened, and I got a dental bridge without any effort.",
      author: "Robert D.",
      title: "International Dental Traveler",
    ...
    <div className="min-h-screen bg-[#fafdfc] text-[#1c2e2c] flex flex-col font-sans">
      ...
      <section className="relative w-full flex flex-col lg:flex-row min-h-[calc(100vh-92px)]">
        ...
        <div className="w-full lg:w-[45%] relative h-[500px] lg:absolute lg:inset-y-0 lg:right-0 lg:h-full bg-brand-mint-dark overflow-hidden">
          <Image
            src="/bridges_hero.png"
            alt="Beautiful natural bridge smile"
            fill
            priority
      ...
      {/* 2.5. WHAT IS A DENTAL BRIDGE VISUALIZATION SECTION */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-12">
            ...
            <div className="lg:col-span-5 w-full">
              <div className="w-full relative aspect-square rounded-[2rem] overflow-hidden shadow-lg border border-brand-teal/5 bg-[#f6faf9] flex items-center justify-center">
                <Image
                  src="/1.jpeg"
                  alt="Dental bridge step diagram"
                  fill
          ...
          <div className="w-full">
            <div className="w-full relative aspect-[16/9] sm:aspect-[21/9] md:aspect-[24/9] lg:aspect-[32/11] rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-lg border border-brand-teal/5 bg-[#f6faf9] flex items-center justify-center">
              <Image
                src="/2.jpeg"
                alt="Dental bridge procedure visualization"
                fill
      ...
      <section id="tabs-section" className="w-full bg-[#f6faf9] py-20 lg:py-32 border-b border-brand-teal/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center flex flex-col items-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6 mb-12 bg-white/60 p-3 rounded-full border border-brand-teal/10 shadow-[0_8px_30px_rgba(8,72,67,0.03)]">
            ...
            >
              Who May Need a Bridge? (Eligibility)
            </button>
            <button
              ...
              <div className="flex flex-col gap-10">
                <div className="text-left w-full">
                  <h3 className="text-2xl sm:text-3xl font-bold text-[#1c2e2c] mb-4">
                    Who May Need A Dental Bridge Treatment?
                  </h3>
                  <p className="text-brand-teal/70 text-base font-light leading-relaxed">
                    A dental bridge is a very common solution that is used for the replacement of one or more missing teeth by bridging the gap between implants or healthy teeth. It assists in the restoration of both functioning and appearance, along with preventing any further oral health complications.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                  ...
                  <div className="bg-[#f4faf9] border border-brand-teal/5 rounded-2xl p-6 sm:p-8 hover:shadow-md transition-shadow duration-300 flex flex-col justify-between">
                    <div>
                      ...
                      <h4 className="text-lg font-bold text-[#1c2e2c] mb-2">Patient with One or More Missing Teeth</h4>
                      <p className="text-[#556966] text-sm leading-relaxed font-light mb-4">
                        A dental bridge can help fill the gap and regain your smile if you have lost a tooth because of injury, decay, or extraction.
                      </p>
                    </div>
                    <div className="flex gap-2 mt-auto">
                      ...
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Tooth loss solution</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f4faf9] border border-brand-teal/5 rounded-2xl p-6 sm:p-8 hover:shadow-md transition-shadow duration-300 flex flex-col justify-between">
                    <div>
                      <div className="flex justify-between items-start mb-4">
                        <div className="w-12 h-12 rounded-xl bg-brand-mint flex items-center justify-center shrink-0">
                          <svg className="w-6 h-6 text-brand-teal" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.5a6.5 6.5 0 100-13 6.5 6.5 0 000 13zM21 21l-4.35-4.35" />
                          </svg>
                        </div>
                        <span className="text-xl font-serif italic text-brand-teal/50">02</span>
                      </div>
                      <h4 className="text-lg font-bold text-[#1c2e2c] mb-2">Facing Complications in Speaking or Chewing</h4>
                      <p className="text-[#556966] text-sm leading-relaxed font-light mb-4">
                        You may experience problems in chewing food or in pronouncing words clearly because of missing teeth. A bridge helps improve chewing and speech.
                      </p>
                    </div>
                    <div className="flex gap-2 mt-auto">
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Speech clarity</span>
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Chewing restoration</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f4faf9] border border-brand-teal/5 rounded-2xl p-6 sm:p-8 hover:shadow-md transition-shadow duration-300 flex flex-col justify-between">
                    <div>
                      <div className="flex justify-between items-start mb-4">
                        <div className="w-12 h-12 rounded-xl bg-brand-mint flex items-center justify-center shrink-0">
                          <svg className="w-6 h-6 text-brand-teal" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-4.5L21 7.5m0 0L16.5 3M21 7.5H7.5" />
                          </svg>
                        </div>
                        <span className="text-xl font-serif italic text-brand-teal/50">03</span>
                      </div>
                      <h4 className="text-lg font-bold text-[#1c2e2c] mb-2">Shifting into Empty Space</h4>
                      <p className="text-[#556966] text-sm leading-relaxed font-light mb-4">
                        If a tooth is missing, nearby teeth may begin to shift into the empty space, causing misalignment. A bridge maintains proper positioning.
                      </p>
                    </div>
                    <div className="flex gap-2 mt-auto">
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Stop tooth shift</span>
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Dental alignment</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f4faf9] border border-brand-teal/5 rounded-2xl p-6 sm:p-8 hover:shadow-md transition-shadow duration-300 flex flex-col justify-between">
                    ...
                    <div className="flex gap-2 mt-auto">
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Facial structure</span>
                      <span className="text-[10px] bg-white text-brand-teal/80 border border-brand-teal/10 px-3 py-1 rounded-full font-medium">Muscle support</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center text-left">
                ...
                <div className="lg:col-span-7">
                  ...
                  <p className="text-brand-teal/70 text-base font-light leading-relaxed mb-8">
                    Bridges offer excellent functional and cosmetic support to restore daily comfort and confidence.
                  </p>
                ...
                <div className="lg:col-span-5 w-full">
                  <div className="w-full relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-lg border border-white bg-white">
                    <Image
                      ...
                      alt="Dental bridge benefits overview"
                      fill
                      className="object-cover"
                      sizes="(max-w-1024px) 100vw, 400px"
                    />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start w-full">
                ...
                <div className="lg:col-span-6 flex flex-col items-start text-left">
                  ...
                  <h3 className="text-3xl sm:text-4xl lg:text-[38px] font-bold tracking-tight text-[#1c2e2c] leading-[1.15] font-sans mb-8">
                    Your Dental Bridge Journey <span className="font-serif italic font-normal text-brand-teal">With HPT</span>
                  </h3>
      ...
      <section className="w-full text-white py-24 sm:py-32 relative overflow-hidden flex items-center justify-center min-h-[500px]">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[36px] font-bold tracking-tight text-white mb-6 leading-[1.25] max-w-3xl font-sans">
            Missing a Tooth and Not Sure Which Option May Be Appropriate For You?
          </h2>
          
          {/* Paragraph */}
          <p className="text-base sm:text-lg text-white/90 leading-relaxed font-light mb-10 max-w-2xl mx-auto">
            Consult with our trusted associated specialists about your bridge treatment for visible gaps, complications in chewing, or nearby tooth support.
          </p>
      ...
      {/* 7. CTA-2 (Booking Form - Preselected with Bridges) */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col items-start text-left">
              ...
              <p className="text-base sm:text-lg text-brand-teal/70 leading-relaxed font-light mb-10 max-w-md">
                Available reports or dental concerns can help you have a better understanding of all possible treatment options.
              </p>
                ...
                <form onSubmit={handleFormSubmit} className="bg-white border border-[#e5ebe9] rounded-[2rem] p-6 sm:p-10 shadow-[0_10px_45px_rgba(0,0,0,0.02)] flex flex-col gap-6 text-left">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <textarea
                      id="message"
                      rows={4}
                      placeholder="Describe your missing teeth, chewing complications, or preferences..."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-5 bg-[#e8f1ef] rounded-[2rem] p-6 sm:p-8 flex flex-col gap-6 text-left">
              <div className="relative w-full aspect-[1.2/1] rounded-2xl overflow-hidden shadow-sm">
                <Image src="/mindera_support_group_clean.png" alt="Dental bridges support and FAQ information" fill className="object-cover" sizes="(max-w-768px) 100vw, 400px" />
              </div>
              ...
              <div>
                ...
                <p className="text-[13px] text-brand-teal/75 leading-relaxed font-light mt-3">
                  Contact our top experts and get complete details with professional consultation.
                </p>
              </div>
            ...
            <div className="lg:col-span-7 flex flex-col text-left">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-[42px] font-bold tracking-tight text-[#1c2e2c] leading-[1.15] font-sans mb-10">
                ...
                About <span className="font-serif italic font-normal text-brand-teal">Dental Bridges</span>
              </h2>
